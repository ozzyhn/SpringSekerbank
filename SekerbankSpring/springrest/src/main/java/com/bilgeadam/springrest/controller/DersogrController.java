...
import com.bilgeadam.springrest.repository.DersOgrencıRepository;
import com.bilgeadam.springrest.repository.DersRepository;
import com.bilgeadam.springrest.repository.OgrencıRepository;

@RestController
@RequestMapping(path = "dersogrenci")
public class DersogrController
{
	private DersOgrencıRepository dersRepository;

	public DersogrController(DersOgrencıRepository dersRepository)
	{
